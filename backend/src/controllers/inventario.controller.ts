...
export const InventoryController = {
    async getAllInventory(req: Request, res: Response) {
        try {
           ...
           const inventarios = await BaseService.getAll<Inventory>(tableName,['id', 'store_id', 'product_id', 'stock', 'created_at','products(id,article,models(id,name))','store(id,name)'], where);
